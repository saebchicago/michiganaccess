...
export const ROUTE_META: RouteMeta[] = [
  ...
  },
  {
    ...
    description:
      "51 verified public data feeds (30 federal, 9 state, 12 nonprofit) from 42 publishers powering the Independent Michigan civic intelligence platform. Every publisher credited.",
    h1: "51 Verified Data Sources",
    summary:
  ...
  },
  {
    ...
    description:
      "Access Michigan platform impact metrics: 83 counties, 51 data sources, 4 languages, zero cost.",
