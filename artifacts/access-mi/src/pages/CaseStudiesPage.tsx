...
const studies = [
  {
    ...
    projectedOutcomes: [
      {
        label: "Underserved ZIPs identified",
        value: "12",
        basis: "HRSA HPSA data",
      },
      {
        label: "Drive-time reduction potential",
        value: "45→15 min",
        basis: "Isochrone modeling",
      },
      {
        label: "Coverage gap addressable",
        value: "+34%",
        basis: "Catchment analysis",
      },
    ],
  },
  {
    ...
    challenge:
      "Nationally, an estimated 50–80% of insurance denials go uncontested. In Michigan, the average time to prepare a manual appeal is estimated at 4–8 hours, creating a significant barrier for working families and vulnerable populations.",
    challengeSource:
      "Kaiser Family Foundation (2023); ASPE/HHS denial rate reports",
    approach: [
    ...
    projectedOutcomes: [
      ...
      },
      {
        ...
        value: "~85%",
        basis: "Workflow analysis",
      },
      {
        label: "Avg. recovery per successful appeal (national)",
        value: "$3,000–5,000",
        basis: "ASPE/HHS estimates",
      },
    ],
  },
  {
    ...
    challenge:
      "An estimated 60–70% of social determinants of health (SDOH) referrals go uncompleted nationally. Fragmented resource directories, eligibility confusion, and phone-tag workflows create cascading abandonment at each handoff point.",
    challengeSource:
        ...
        <div className="container max-w-5xl">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Three scenarios demonstrating how Access Michigan's data
              infrastructure could support health equity analysis, operational
              planning, and community navigation.
            </p>
          </motion.div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  based on real public data sources. They are not reports of
                  actual outcomes achieved. Access Michigan is in Public Beta
                  and these scenarios illustrate the platform's analytical
                  potential. No endorsement by named agencies is implied.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <div className="rounded-lg border border-border bg-muted/50 p-5 flex items-start gap-3">
            ...
            <div className="text-xs text-muted-foreground space-y-2">
              <p>
                <strong className="text-foreground">Data Sources:</strong> All
                challenge statements cite authoritative public sources. See{" "}
                <Link
                  to="/data-validation"
              ...
              <p>
                <strong className="text-foreground">Platform Status:</strong>{" "}
                Access Michigan is in Public Beta. These scenarios illustrate
                the types of analysis the platform's data infrastructure can
                support. Actual impact measurement will be published as the
                platform matures.
              </p>
            </div>
          </div>
