...
export default function DisasterHistoryPage() {
  ...
  return (
    <Layout>
      <Breadcrumbs items={[{ label: "Data & Insights", href: "/data-and-insights" }, { label: "Disaster History" }]} />

      <section className="bg-gradient-to-b from-primary/5 to-background py-12">
        <div className="container max-w-5xl">
          <motion.div initial="hidden" animate="visible" variants={fade}>
            <Badge variant="outline" className="mb-3 uppercase tracking-wider text-xs">Live FEMA Data</Badge>
            <h1 className="text-3xl font-extrabold text-foreground mb-2">Michigan Disaster History</h1>
            <p className="text-muted-foreground">
              Every federal disaster declaration affecting Michigan since 1953, sourced live from the FEMA OpenFEMA API.
            </p>
          </motion.div>
        </div>
      </section>
