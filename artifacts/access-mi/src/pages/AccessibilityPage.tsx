...
const standards = [
  {
    ...
    items: [
      "Color contrast designed to the WCAG 2.1 AA minimum (4.5:1 text, 3:1 large text); automated checks currently report 6 of 10 priority routes free of critical/serious violations - see the changelog",
  ...
  {
    icon: Globe,
    title: "Language & Cultural Access",
    items: [
  ...
  },
  {
    ...
    items: [
      "Touch targets designed to a 44×44px minimum for mobile interactions (automated verification of this target is still being tightened)",
...
const testingMethods = [
  "Automated axe-core smoke checks (vitest-axe) that run in blocking continuous integration on every change, plus a broader Playwright axe suite runnable locally",
...
export default function AccessibilityPage() {
  usePageMeta({
    ...
    description:
      "Access Michigan works toward WCAG 2.1 AA conformance - currently partially conformant, with automated and manual testing on every change.",
    path: "/accessibility",
  });
    ...
    <Layout>
      ...
      <section className="bg-gradient-to-b from-primary/5 to-background py-16 lg:py-24">
        <div className="container max-w-4xl text-center">
          ...
          >
            Access Michigan is committed to ensuring equitable access to public
            service information for all Michigan residents, regardless of
        ...
        >
          <div className="rounded-2xl border border-primary/20 bg-primary/5 p-8 lg:p-12">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              Access Michigan strives to conform to the{" "}
              <strong>
                Web Content Accessibility Guidelines (WCAG) 2.1 Level AA
              </strong>{" "}
              standards and is currently <strong>partially conformant</strong>:
              automated checks report 6 of 10 priority routes free of critical
              or serious violations, and remediation of the remainder is tracked
              in the changelog. These guidelines are developed by the World Wide
              Web Consortium (W3C) and are widely regarded as the international
            ...
            <p className="text-muted-foreground leading-relaxed">
              As a civic resource serving vulnerable populations - including
              uninsured residents, seniors with limited digital literacy,
              refugees navigating language barriers, and people with
              disabilities - accessibility is not an afterthought. It is a core
              design principle that informs every decision we make.
            </p>
          </div>
        </motion.section>
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  How we implement inclusive design across the platform
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  How we verify and maintain accessibility compliance
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Areas we are actively working to improve
                </p>
              </div>
            </div>
          </motion.div>
        ...
        >
          <div className="rounded-2xl border border-michigan-teal/20 bg-michigan-teal/5 p-8 lg:p-12 text-center">
            ...
            <p className="text-muted-foreground leading-relaxed max-w-xl mx-auto mb-6">
              If you encounter any accessibility barriers while using Access
              Michigan, we want to know. Your feedback helps us improve the
