...
const DOWNLOADS: { section: string; items: DownloadItem[] }[] = [
  {
    ...
    items: [
      ...
      },
      {
        title: "ZIP Scorecard",
        description:
          "Neighborhood-level health scorecard with CDC PLACES, IRS SOI, and Census data.",
        icon: BarChart3,
        action: "link",
        href: "/zip/48201",
      },
      {
        ...
        description:
          "Side-by-side analysis of up to 4 counties across 20+ indicators.",
        icon: BarChart3,
        action: "link",
        href: "/compare",
      },
    ...
    items: [
      {
        ...
        description:
          "Interactive map of health disparities across all 83 Michigan counties.",
        icon: Map,
        action: "link",
        href: "/health-equity-atlas",
      },
      {
        title: "Detection Gap Funnel",
        description:
          "Visualize screening-to-treatment drop-off rates by condition and county.",
        icon: BarChart3,
        action: "link",
        href: "/detection-gap",
      },
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Complete catalog of every federal and state dataset we aggregate.",
        icon: ExternalLink,
        action: "link",
        href: "/data-sources",
      },
      ...
      <div className="container max-w-4xl py-10 md:py-16 space-y-10">
        <div className="text-center space-y-3">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Every report on Access Michigan can be saved as a PDF using your
            browser's print dialog. No account required.
          </p>
        </div>
        ...
        <div className="rounded-xl border border-border bg-muted/30 p-6 text-center space-y-2">
          <p className="text-sm text-muted-foreground">
            <strong className="text-foreground">Tip:</strong> On any page, press{" "}
