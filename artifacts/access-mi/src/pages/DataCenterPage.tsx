...
const pipelineProjects: PipelineProject[] = [
  {
    project: "Stargate",
    location: "Saline Twp (Washtenaw)",
    developer: "Oracle/OpenAI/Related Digital",
    capacity: "1.4 GW",
    investment: "$7B",
    investmentBillions: 7,
    status: "MPSC approved",
  },
  {
    project: "Project Flex",
    location: "Lyon Twp (Oakland)",
    developer: "Verrus/Sidewalk Infra/Alphabet",
    capacity: "1.8M sq ft",
    investment: "TBD",
    investmentBillions: null,
    status: "Conditional approval",
  },
  {
    project: "Project Cannoli",
    location: "Van Buren Twp (Wayne)",
    developer: "Panattoni",
    capacity: "1 GW",
    investment: "TBD",
    investmentBillions: null,
  ...
  {
    project: "Switch Pyramid",
    location: "Gaines Twp (Kent)",
    developer: "Switch",
    capacity: "237 MW",
    investment: "Part of $5B",
    investmentBillions: 5,
    status: "Phase 3",
  },
  {
    project: "Microsoft",
    location: "Kent/Allegan",
    developer: "Microsoft",
    capacity: "TBD",
    investment: "TBD",
    investmentBillions: null,
  ...
  {
    project: "UofM/Los Alamos",
    location: "Ypsilanti Twp",
    developer: "UM + LANL",
    capacity: "TBD",
    investment: "$1.25B",
    investmentBillions: 1.25,
    status: "Planning",
  },
  {
    project: "DAMAC Properties",
    location: "TBD",
    developer: "DAMAC",
    capacity: "TBD",
    investment: "$500M",
    investmentBillions: 0.5,
    status: "Construction Q1 2026",
  },
];

// Headline aggregates derived from the pipeline table above so the hero
// number can't drift from what users see when they scroll. Projects
// whose dollar amount is "TBD" are excluded from the disclosed total but
// counted toward the project count.
const disclosedInvestmentBillions = pipelineProjects
  .map((p) => p.investmentBillions ?? 0)
  .reduce((s, n) => s + n, 0);
const tbdProjectCount = pipelineProjects.filter(
  (p) => p.investmentBillions == null,
).length;
...
const energyDemandSplit = [
  {
    name: "Current Residential/Commercial",
    value: 55,
    color: "hsl(209, 86%, 31%)",
  },
  { name: "Current Industrial", value: 30, color: "hsl(215, 19%, 55%)" },
  {
    name: "Projected Data Center (by 2035)",
    value: 15,
    color: "hsl(0, 100%, 71%)",
  },
];
  ...
  return (
    <Layout>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-michigan-teal/5 to-background py-16 md:py-20">
        <div className="container">
          ...
          >
            ...
            >
              <strong>{investmentDisplay}</strong> in disclosed investment
              across <strong>{pipelineProjects.length}</strong> announced
              projects
              {tbdProjectCount > 0
                ? ` (${tbdProjectCount} with dollar amounts still TBD)`
                : ""}
              . Tracking investment, energy demand, community impact, and
              environmental concerns across the state.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="container max-w-6xl py-10 space-y-12">
          ...
          <Card className="border-primary/20 bg-primary/5">
            ...
            <CardContent>
              ...
              <ul className="space-y-1.5 text-sm text-muted-foreground">
                <li>
                  • 19-year DTE contract, approved Dec 18, 2025 (MPSC Case
                  U-21990)
                </li>
                  ...
                  <tbody>
                    {pipelineProjects.map((p) => (
                      <tr key={p.project} className="border-b border-border/50">
                        ...
                        <td className="py-3">
                          <Badge
                            className={`text-[10px] ${statusColors[p.status] || "bg-muted text-muted-foreground"}`}
                          >
                            {p.status}
                          </Badge>
                        </td>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Known capacity figures for major projects
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Current vs. projected data center share by 2035
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={280}>
            ...
            {[
              {
                ...
                value: "8.4 GW",
                detail:
                  "1.4 GW executed, 3+ GW advanced talks, 4+ GW additional",
              },
              {
                label: "Consumers Pipeline",
                value: "~15 GW",
                detail: "Economic development pipeline; ~3 GW probable by 2035",
              },
              {
                label: "Combined Demand",
                value: "~16 GW",
                detail: "Would nearly double combined utility demand",
              },
              {
                label: "UCS Projection",
                value: "2× by 2050",
                detail: "57% of demand growth by 2030 from data centers",
              },
            ].map((item) => (
              <Card key={item.label}>
        ...
        >
          <h2 className="text-xl font-bold text-foreground mb-4 flex items-center gap-2">
            <Landmark className="h-5 w-5 text-primary" /> Community & Fiscal
            Impact
          </h2>
          <div className="grid gap-6 sm:grid-cols-2">
            <Card>
              <CardContent className="p-6">
                <h3 className="font-semibold text-foreground mb-2">
                  Tax Incentives (PA 207-208 of 2024)
                </h3>
                <ul className="space-y-1.5 text-sm text-muted-foreground">
                  <li>
                    • HB 4906/SB 237: 6% sales tax exemption on equipment
                    through 2050
                  </li>
                  <li>
                    • Requirements: $250M min investment, 30 jobs at 150% median
                    wage, green building cert, 90% clean energy
                  </li>
                  <li>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <ul className="space-y-1.5 text-sm text-muted-foreground">
                  <li>
                    • <strong>19+ townships/cities</strong> passed data center
                    moratoriums
                  </li>
                  <li>• Stargate: $8M+/year for area schools</li>
                  <li>
                    • Projected $300M/year net ratepayer benefit (DTE estimate)
                  </li>
                  <li>
                    • 2,500 union construction jobs + ~450 permanent (Stargate
                    alone)
                  </li>
                </ul>
              </CardContent>
            ...
            <CardContent className="p-6">
              <div className="flex items-start gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Key environmental considerations for Michigan's data center
                    expansion.
                  </p>
                </div>
              </div>
              <div className="grid gap-4 sm:grid-cols-3">
                ...
                <div className="rounded-lg bg-background border border-border p-4">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Michigan electricity demand could nearly double by 2050
                    (UCS). 57% of growth by 2030 from data centers alone.
                  </p>
                </div>
                <div className="rounded-lg bg-background border border-border p-4">
                  ...
                  <p className="text-xs text-muted-foreground">
                    19+ moratoriums reflect local concerns about land use,
                    noise, and infrastructure strain. Rezoning battles ongoing
        ...
        >
          <div className="flex flex-wrap gap-3 justify-center">
            <Button variant="outline" asChild>
              <Link to="/environment">
                Environment & Energy <ExternalLink className="ml-2 h-3 w-3" />
              </Link>
            </Button>
            <Button variant="outline" asChild>
              <Link to="/energy-burden">
                Energy Burden <ExternalLink className="ml-2 h-3 w-3" />
              </Link>
            </Button>
            <Button variant="outline" asChild>
              <Link to="/civic-data">
                Civic Data Hub <ExternalLink className="ml-2 h-3 w-3" />
              </Link>
            </Button>
            <Button variant="outline" asChild>
              <Link to="/detection-gap">
                Detection Gap Funnel <ExternalLink className="ml-2 h-3 w-3" />
              </Link>
            </Button>
            <Button variant="outline" asChild>
              <Link to="/health-equity-atlas">
                Health Equity Atlas <ExternalLink className="ml-2 h-3 w-3" />
              </Link>
            </Button>
          </div>
        </motion.section>
        ...
        <section className="text-center">
          <p className="text-xs text-muted-foreground">
            Sources: MPSC Case U-21990, DTE IRP filings, Union of Concerned
            Scientists (UCS), Michigan Legislature (PA 207-208 of 2024), local
            township meeting minutes, published project announcements.
          </p>
        </section>
      </div>
    </Layout>
