...
import { SITEMAP_SECTIONS, type SitemapSection } from "@/routes/manifest";
...
export default function SitemapPage() {
  usePageMeta({
    title: "Site Map",
    description:
      "Complete navigation tree for Access Michigan - find any page or feature quickly.",
    path: "/sitemap",
  });
        ...
        <div className="container max-w-3xl">
          ...
          <div className="mt-10 text-center">
            <p className="text-[10px] text-muted-foreground">
              {SITEMAP_SECTIONS.reduce((acc, s) => acc + s.links.length, 0)}{" "}
              pages across {SITEMAP_SECTIONS.length} categories ·{" "}
