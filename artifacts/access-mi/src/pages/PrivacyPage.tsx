      ...
      <div className="container max-w-4xl py-12 space-y-14">
        ...
        <Section icon={Shield} title="1. Overview" index={0}>
          <p>
            ...
            civic resource that helps Michigan residents navigate healthcare,
            social services, and community resources. We are{" "}
            <strong>
              not a government agency, healthcare provider, or insurance company
            </strong>
            . We do not sell advertising, and we do not monetize your data in
            any way.
          </p>
          <p>
            Our guiding principle is <strong>privacy by design</strong>: we
            collect the absolute minimum information needed to operate and
            improve the Platform. Where possible, data processing occurs
            entirely in your browser and never reaches our servers.
          </p>
        </Section>
        ...
        <Section icon={Lock} title="2. What We Do NOT Do" index={1}>
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>No targeted advertising</strong> - Access Michigan
              displays zero ads.
            </li>
            <li>
              <strong>No sale or sharing of personal data</strong> - We never
              sell, rent, license, or share your information with third parties
              for marketing.
            </li>
            <li>
              <strong>No user accounts or login required</strong> - The Platform
              is fully accessible without creating an account or providing
            ...
            <li>
              ...
              - Health-related tools (AI appeals generator, benefits wizard,
              symptom information) are processed via secure server functions
              that do not store your inputs after the response is returned. We
              do not retain health information beyond the immediate request.
            </li>
          </ul>
        </Section>
        ...
        >
          ...
          <p className="mt-3">
            These logs are retained for <strong>30 days or less</strong> and are
            used exclusively for security monitoring, error detection, and
            capacity planning. They are never analyzed to identify individual
            users.
          </p>
          ...
          <p>
            If you choose to use certain features, you may provide information
            voluntarily:
          </p>
          <ul className="list-disc pl-6 space-y-1.5 mt-2">
            <li>
              <strong>Contact Form:</strong> Name, email address, subject, and
              message. Used solely to respond to your inquiry.
            </li>
            <li>
              <strong>Resource Submissions:</strong> Organization details
              submitted for inclusion in our directory.
            </li>
            <li>
              <strong>Page Feedback:</strong> Anonymous "helpful/not helpful"
              ratings with optional comments (no personal data collected).
            </li>
            <li>
              <strong>Partnership Inquiries:</strong> Organization and contact
              details for partnership evaluation.
            </li>
          </ul>
          ...
          <p>
            Some features use your browser's{" "}
            <code className="rounded bg-muted px-1.5 py-0.5 text-xs">
              localStorage
            </code>{" "}
            to remember preferences (theme, language, recently viewed counties).
        ...
        <Section icon={Eye} title="4. Automated Features" index={3}>
          <p>
            ...
            and insurance appeal letter generator. Important privacy details
            about these features:
          </p>
          <ul className="list-disc pl-6 space-y-2 mt-3">
            <li>
              <strong>No conversation logging:</strong> AI chat messages are
              processed in real-time via secure backend functions and are{" "}
              <strong>not stored</strong> on our servers after the response is
              delivered.
            </li>
            <li>
              <strong>No PHI storage:</strong> Any health details, insurance
              information, or personal circumstances you enter into the appeal
              generator or chat are processed transiently and discarded
              immediately after generating a response.
            </li>
            <li>
              <strong>Third-party AI models:</strong> AI responses are generated
              by third-party language model providers. Your prompts are sent to
              these providers under their data processing terms. We select
              providers that do not use input data for model training.
            </li>
            <li>
              <strong>Not medical advice:</strong> AI-generated content is
              informational only and does not constitute medical, legal, or
              insurance advice. See Section 7 for HIPAA disclaimers.
            </li>
          </ul>
        </Section>
        ...
        <Section icon={Globe} title="5. Third-Party Services" index={4}>
          <p>
            ...
            resources from third-party services. Each may have its own privacy
            policy:
          </p>
            ...
            {[
              {
                ...
                note: "Map tiles served via CARTO CDN, using OpenStreetMap data. See carto.com/legal and openstreetmap.org/privacy",
              },
              {
                name: "Federal & State Data APIs",
                purpose: "CMS, HRSA, CDC, EPA, NWS data",
                note: "Requests routed through our secure proxy functions; your IP is not forwarded",
              },
              {
                name: "AI Model Providers",
                purpose: "Chat and appeal generation",
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            ...
            policy on external links to prevent destination sites from knowing
            which Access Michigan page you came from.
          </p>
        </Section>
        ...
        <Section icon={Shield} title="6. Data Security" index={5}>
          ...
          <ul className="list-disc pl-6 space-y-2 mt-3">
            <li>
              <strong>Encryption in transit:</strong> All connections use
              HTTPS/TLS encryption.
            </li>
            <li>
              <strong>Row-Level Security (RLS):</strong> Database tables enforce
              strict access controls. Public submissions (contact forms,
              feedback) are insert-only; no public read or modification access.
            </li>
            <li>
              <strong>Input validation:</strong> All backend functions validate
              and sanitize inputs using Zod schema validation.
            </li>
            <li>
              <strong>Rate limiting:</strong> Backend functions enforce rate
              limits (5–10 requests per minute) to prevent abuse.
            </li>
            <li>
              <strong>No authentication required:</strong> Since we don't
              require accounts, there are no passwords or credentials to protect
        ...
        <Section icon={AlertTriangle} title="7. HIPAA Disclaimer" index={6}>
          <div className="rounded-xl border-2 border-michigan-coral/30 bg-michigan-coral/5 p-6">
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              <p>
                <strong>
                  Access Michigan is NOT a covered entity under the Health
                  Insurance Portability and Accountability Act (HIPAA).
                </strong>{" "}
                We are not a healthcare provider, health plan, or healthcare
                clearinghouse.
              </p>
              <p>
                Because Access Michigan does not collect, store, process, or
                transmit Protected Health Information (PHI), HIPAA regulations
                do not apply to this Platform. However, we voluntarily adopt
                privacy-protective practices that align with the spirit of
                HIPAA's Privacy Rule:
              </p>
              <ul className="list-disc pl-6 space-y-1.5">
                <li>
                  We design tools so that health-related data is processed
                  client-side whenever possible.
                </li>
                <li>
                  When server-side processing is necessary (e.g., AI features),
                  data is processed transiently and not persisted.
                </li>
                <li>
                  We do not combine health-related inputs with any identifying
                  information.
                </li>
                <li>
                  We do not share any user inputs with third parties for
                  purposes beyond immediate response generation.
                </li>
              </ul>
              <p className="font-medium text-foreground">
                If you need to share sensitive health information, please
                communicate directly with your healthcare provider through their
                HIPAA-compliant patient portal or secure messaging system.
              </p>
            </div>
          </div>
        </Section>
        ...
        >
          <p>
            Michigan residents have specific privacy protections under state and
            federal law:
          </p>
          ...
          <p>
            Although Access Michigan does not collect personal identifying
            information as defined by this Act, we comply with its requirements
            for any data we do handle, including prompt notification in the
          ...
          <p>
            Access Michigan does not engage in trade or commerce and makes no
            commercial representations. All information is provided as a free
            civic resource for public benefit.
          </p>
          ...
          <p>
            Access Michigan is designed for a general audience and does not
          ...
          <ul className="list-disc pl-6 space-y-1.5 mt-2">
            <li>
              <strong>Access:</strong> Request a copy of any personal
              information we hold about you (likely none, given our minimal
              collection).
            </li>
            <li>
              <strong>Deletion:</strong> Request deletion of any data you've
              submitted through contact forms or resource submissions.
            </li>
            <li>
            ...
            <li>
              <strong>Opt-out:</strong> Clear browser localStorage at any time
