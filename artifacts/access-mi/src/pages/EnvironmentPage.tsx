...
const fallbackAQI = [
  {
    ...
    status: "Moderate",
    color: "hsl(27, 87%, 67%)",
    measure: "Current asthma prevalence",
  },
  {
    city: "Grand Rapids",
    aqi: 38,
...
const envJusticeAreas = [
  {
    ...
    issue: "Industrial emissions, legacy contamination",
    pop: "65,000",
    priority: "Critical",
  },
  {
    area: "Flint",
    issue: "Water infrastructure, lead remediation",
    pop: "95,000",
    priority: "Critical",
  },
  {
    area: "Benton Harbor",
    issue: "Lead service lines, water quality",
    pop: "9,700",
    priority: "High",
  },
  {
    area: "Muskegon Heights",
    issue: "Brownfield sites, air quality",
    pop: "10,500",
    priority: "High",
  },
  {
    area: "Saginaw",
    issue: "Industrial legacy, flood vulnerability",
    pop: "44,000",
    priority: "Moderate",
  },
];
...
const getQuickStats = (t: (key: string) => string) => [
  {
    icon: Wind,
    label: t("environment.airMonitoring"),
    value: "94",
...
const EnvironmentPage = () => {
  ...
  usePageMeta({
    title: "Michigan Environmental Health | Access Michigan",
    description:
      "Air quality, environmental burden, and pollution indicators across Michigan's 83 counties.",
    path: "/environment",
  });
  ...
  const {
    data: cdcData,
    isLoading: cdcLoading,
    isError: cdcError,
  } = useCDCData("places-county", "", 50);

  // Use live CDC data when available, fallback otherwise
  const aqiData =
    cdcData?.results && cdcData.results.length > 0
      ? transformPlacesToAQI(cdcData.results)
      : fallbackAQI;

  const isLiveData =
    cdcData?.results && cdcData.results.length > 0 && !cdcError;
        ...
        <div className="container">
          <div className="mb-4">
            <h2 className="text-xl font-bold text-foreground">
              Michigan Environmental Burden by County
            </h2>
            <p className="text-sm text-muted-foreground mt-1">
              EJScreen-based burden scores across all 83 counties. Click any
              county to explore indicators.
            </p>
          </div>
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="flex items-center gap-2">
                        ...
                        {isLiveData
                          ? t("environment.asthmaPrevalence")
                          : t("environment.aqiByCity")}
                        {cdcLoading && (
                      ...
                      <div className="mt-4 flex flex-wrap items-center gap-3 text-xs">
                        {isLiveData ? (
                          ...
                          >
                            ...
                            {cdcData?.cached_at
                              ? new Date(cdcData.cached_at).toLocaleDateString()
                              : "recently"}
                          </Badge>
                        ) : (
                          <>
              ...
              >
                <Card className="hover:border-michigan-sky/30 transition-colors">
                  <CardContent className="p-6">
                    ...
                    <p className="mb-4 text-sm text-muted-foreground">
                      Michigan has 40+ air monitoring stations. Check real-time
                      AQI by ZIP code through MiAir or AirNow.
                    </p>
                ...
                <Card className="hover:border-michigan-teal/30 transition-colors">
                  <CardContent className="p-6">
                    ...
                    <p className="mb-4 text-sm text-muted-foreground">
                      Real-time buoy data, stream flow, and water quality from
                      GLOS/Seagull, USGS, and EGLE monitoring networks.
                    </p>
                    <div className="flex flex-wrap gap-2">
                      <Button variant="outline" size="sm" asChild>
                        <a
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-muted-foreground">
                        Michigan's water safety journey - from Flint to PFAS to
                        lead line replacement - makes water quality data more
                        essential here than almost anywhere in America.
                      </p>
                    </div>
                  </div>
                </motion.div>
                ...
                <div className="grid gap-6 md:grid-cols-3">
                  ...
                  <motion.div variants={fadeUp}>
                    <Card className="h-full">
                      ...
                      <CardContent className="space-y-3">
                        <p className="text-sm text-muted-foreground">
                          Michigan has identified <strong>200+</strong> PFAS
                          sites - more than any other state. MPART (established
                          2017) coordinates response.
                        </p>
                        <ul className="space-y-2 text-xs text-muted-foreground">
                          <li>
                            • Michigan MCL (2020): PFOA 8 ppt, PFOS 16 ppt.
                            Federal EPA MCL (April 2024): 4.0 ppt for PFOA/PFOS.
                          </li>
                          <li>
                          ...
                          <li>
                            • Well testing available for private well owners
                          </li>
                        </ul>
                  ...
                  <motion.div variants={fadeUp}>
                    <Card className="h-full">
                      ...
                      <CardContent className="space-y-3">
                        <p className="text-sm text-muted-foreground">
                          <strong>Flint:</strong> 98% of lead lines replaced,
                          ~500 remaining. Spring 2026 work scheduled to complete
                          the project.
                        </p>
                        <ul className="space-y-2 text-xs text-muted-foreground">
                          <li>
                            • Federal Lead & Copper Rule Revisions (LCRR)
                            effective Oct 2024
                          </li>
                          <li>
                            • All Michigan water systems must inventory lead
                            lines
                          </li>
                          <li>
                            • MiLeadSafe tracks replacement progress statewide
                          </li>
                        </ul>
                        <div className="flex flex-col gap-2 pt-2">
                          <a
                  ...
                  <motion.div variants={fadeUp}>
                    <Card className="h-full">
                      <CardHeader>
                        <CardTitle className="flex items-center gap-2 text-base">
                          <Droplets className="h-4 w-4 text-michigan-sky" />{" "}
                          Drinking Water
                        </CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-3">
                        <p className="text-sm text-muted-foreground">
                          EGLE oversees Michigan's public water systems and
                          provides well water resources for the 1.1M+ households
                          on private wells.
                        </p>
                        <ul className="space-y-2 text-xs text-muted-foreground">
                          ...
                          <li>
                            • Water Well Viewer: look up well logs by address
                          </li>
                        </ul>
                        <div className="flex flex-col gap-2 pt-2">
                          <a
                ...
                <motion.div variants={fadeUp}>
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Cents per kWh · Source: U.S. Energy Information
                        Administration (EIA SEDS) · 1990–2023
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <ResponsiveContainer width="100%" height={300}>
                      ...
                      <p className="text-xs text-muted-foreground mt-3">
                        <strong>Insight:</strong> Michigan residential
                        electricity prices have risen 174% since 1990, outpacing
                        the national average by 27%. This gap widened after 2010
                        due to coal-plant retirements and transmission
                        investments.
                      </p>
                    </CardContent>
                  </Card>
                ...
                <motion.div variants={fadeUp}>
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Million BTU per person · Source: EIA SEDS · 1990–2023
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <ResponsiveContainer width="100%" height={300}>
                        <AreaChart data={eiaSEDS}>
                          ...
                          <Tooltip
                            formatter={(v: number) => [`${v} MBTU/person`]}
                          />
                          <Legend />
                          <Area
                            type="monotone"
                            dataKey="miConsumption"
                            stroke="hsl(209, 86%, 31%)"
                            fill="hsl(209, 86%, 31%)"
                            fillOpacity={0.15}
                            strokeWidth={2}
                      ...
                      <p className="text-xs text-muted-foreground mt-3">
                        <strong>Insight:</strong> Michigan's per-capita energy
                        consumption has declined 13% since 2005, driven by
                        efficiency programs and deindustrialization - now 18%
                  ...
                  {[
                    ...
                    >
                      <CardContent className="p-6">
                        ...
                        >
                          {t("environment.learnMore")} about {item.title}{" "}
                          <ExternalLink
              ...
              >
                  ...
                  <div className="grid gap-6 sm:grid-cols-2">
                    ...
                    <Card className="hover:border-michigan-gold/30 transition-colors">
                      <CardContent className="p-6">
                        ...
                        <p className="text-sm text-muted-foreground mb-3">
                          Point-of-sale rebates: heat pump HVAC up to{" "}
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            ...
                            - Terminated December 31, 2025 by the "One Big
                            Beautiful Bill" (signed July 4, 2025).
                          </p>
                          <p className="text-sm text-muted-foreground mt-2">
                            <strong>
                              25D (Residential Clean Energy Credit): STILL
                              ACTIVE
                            </strong>{" "}
                            - 30% through 2032 for solar, wind, geothermal, and
                            battery storage. MiHER rebates are stackable with
                            25D and utility rebates.
                          </p>
                        </div>
                      </div>
                    </CardContent>
                ...
                <motion.div variants={fadeUp}>
                  ...
                  <Card className="hover:border-michigan-teal/30 transition-colors">
                    <CardContent className="p-6">
                      <h3 className="font-semibold text-foreground mb-2">
                        Michigan Saves - Low-Interest Green Loans
                      </h3>
                      <p className="text-sm text-muted-foreground mb-3">
                  ...
                  <div className="grid gap-6 sm:grid-cols-2">
                    <Card className="hover:border-michigan-forest/30 transition-colors">
                      <CardContent className="p-6">
                        ...
                        <p className="text-sm text-muted-foreground mb-3">
                          Low-income funding: <strong>$63M</strong> (2024),{" "}
                    ...
                    <Card className="hover:border-michigan-forest/30 transition-colors">
                      <CardContent className="p-6">
                        ...
                        <p className="text-sm text-muted-foreground mb-3">
                          ...
                          increase). Cumulative savings since 2009: over{" "}
                          <strong>$5.5 billion</strong>. Nearly 200,000
                ...
                <motion.div variants={fadeUp}>
                  <h2 className="text-xl font-bold text-foreground mb-4 flex items-center gap-2">
                    <Globe className="h-5 w-5 text-primary" /> Workforce &
                    Training
                  </h2>
                  <Card className="hover:border-primary/30 transition-colors">
                    <CardContent className="p-6">
                      ...
                      <p className="text-sm text-muted-foreground mb-3">
                        State-funded training grants for employers to train new
                        and current workers in high-demand industries including
                        clean energy, advanced manufacturing, and skilled
                        trades.
                      </p>
                      <Button variant="outline" size="sm" asChild>
                        <a
                ...
                <motion.div variants={fadeUp}>
                  <h2 className="text-xl font-bold text-foreground mb-4 flex items-center gap-2">
                    <MapPin className="h-5 w-5 text-michigan-sky" />{" "}
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        ...
                        drop-off programs · Source: Michigan EGLE
                      </CardDescription>
                    </CardHeader>
                ...
                <motion.div variants={fadeUp}>
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        The nation's most successful deposit-return program
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      ...
                      <Accordion type="single" collapsible className="mt-6">
                        <AccordionItem value="how">
                          <AccordionTrigger className="text-sm">
                            How does the deposit program work?
                          </AccordionTrigger>
                          <AccordionContent className="text-sm text-muted-foreground">
                            Michigan's Bottle Deposit Law requires a 10-cent
                            deposit on carbonated beverage containers. When you
                            return containers to a retailer or reverse vending
                            machine, you receive your 10¢ back per container.
                            Unclaimed deposits fund environmental programs.
                          </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="where">
                          <AccordionTrigger className="text-sm">
                            Where can I recycle beyond bottles?
                          </AccordionTrigger>
                          <AccordionContent className="text-sm text-muted-foreground">
                            Michigan has 600+ drop-off recycling sites and
                            growing curbside programs. Visit{" "}
                            <a
                            ...
                            for locations and accepted materials near you.
                          </AccordionContent>
                        </AccordionItem>
                      </Accordion>
                    </CardContent>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        ...
                        containing 20% of the world's surface freshwater.
                        Protecting these ecosystems is critical to our economy,
                ...
                <motion.div variants={fadeUp} className="mt-8">
                  <Accordion type="single" collapsible>
                    ...
                    <AccordionItem value="algal">
                      ...
                      <AccordionContent className="text-muted-foreground">
                        Nutrient runoff from agriculture and stormwater fuels
                        harmful algal blooms, particularly in Lake Erie and
                        inland lakes. These blooms produce toxins dangerous to
                        humans and pets. Michigan tracks active blooms and
                        issues public health advisories through EGLE.
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="pfas">
                      <AccordionTrigger>PFAS Contamination</AccordionTrigger>
                      <AccordionContent className="text-muted-foreground">
                        Michigan has identified 200+ PFAS contamination sites -
                        more than any other state. "Forever chemicals" from
                        firefighting foam and industrial waste have contaminated
                        groundwater and surface water. Michigan adopted state
                        MCLs in 2020: PFOA 8 ppt, PFOS 16 ppt. The April 2024
                        federal EPA rule set 4.0 ppt for PFOA/PFOS.
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
                </motion.div>
              ...
              <motion.div initial="hidden" animate="show" variants={stagger}>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-muted-foreground">
                        ...
                        disproportionately bear environmental burdens - from air
                        pollution to contaminated water. Michigan's Office of
                ...
                <motion.div variants={fadeUp}>
                  <Card>
                    <CardHeader>
                      <CardTitle>
                        Priority Environmental Justice Communities
                      </CardTitle>
                      <CardDescription>
                        Areas identified for enhanced monitoring, remediation,
                        and investment
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                >
                  <Card>
                    <CardContent className="p-6">
                      ...
                      <p className="mb-4 text-sm text-muted-foreground">
                        Use the EPA's EJScreen tool to explore environmental
                        justice indicators for any Michigan community -
                        pollution burden, health vulnerabilities, and
                        demographic factors.
                      </p>
                  ...
                  <Card>
                    <CardContent className="p-6">
                      ...
                      <p className="mb-4 text-sm text-muted-foreground">
                        Witnessed illegal dumping, unusual odors, or water
                        discoloration? Report concerns to Michigan EGLE's
                        24-hour Pollution Emergency Alerting System (PEAS).
                      </p>
                      <Button variant="outline" asChild>
                        <a
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-base">
                        Michigan Food Access
                      </CardTitle>
                      <CardDescription>
                        200+ census tracts classified as food deserts. 23.5% of
                        Michigan residents live in low-access areas. Source:
                        ...
                        {[
                          ...
                          >
                            ...
                            <span className="w-20 text-right text-[10px] text-muted-foreground">
                              {r.pop.toLocaleString()} no car
                            </span>
                          </div>
                        ))}
                        <p className="text-[9px] text-muted-foreground/60 mt-2">
                          % of census tracts classified as low-access. "No car"
                          = no vehicle + low food access population. Source:
                          USDA FARA 2019
                        </p>
                      </div>
                    </CardContent>
                  ...
                  <Card className="border-red-200/50 dark:border-red-900/30 bg-red-50/30 dark:bg-red-950/10">
                    <CardContent className="py-5">
                      <h3 className="text-sm font-bold text-foreground mb-1">
                        Most Vulnerable: Wayne County
                      </h3>
                      <p className="text-xs text-muted-foreground leading-relaxed">
                        98,000 residents with no vehicle AND low food access -
                        the highest concentration in Michigan. Food deserts in
                        Detroit, Flint, and Saginaw overlap with transit
                        deserts, creating compounding access barriers.
                      </p>
                      <p className="text-[9px] text-muted-foreground/60 mt-2">
        ...
        <div className="container text-center">
          ...
          {!isLiveData && (
            <p className="mt-2 text-xs text-muted-foreground">
              ⚠ Some charts display cached reference values while live data
              sources load.
            </p>
          )}
        </div>
