...
const quadrants = [
  {
    ...
    stats: [
      {
        text: "60% fewer mental health providers per capita in northern Michigan vs. state average",
        source: "HRSA HPSA",
      },
      {
        text: "50–80% of insurance denials go uncontested nationally",
        source: "Kaiser Family Foundation, 2023",
      },
      {
        text: "60–70% of SDOH referrals go uncompleted due to fragmented directories",
        source: "ASPE/HHS, 2022",
      },
      {
        text: "Public health data scattered across 83 county departments and federal portals",
  ...
  },
  {
    ...
    stats: [
      {
        text: "Equity-centered navigation with Social Vulnerability Index (SVI) integration",
      ...
      {
        text: `Real-time data aggregation from ${DATA_SOURCE_DISPLAY} public sources (CMS, HRSA, CDC, MDHHS)`,
        source: "Data validation page",
      },
      {
        text: "Insurance appeal builder with Michigan-specific legal references",
        source: "MCL 500.2213",
      },
    ],
  },
  {
    ...
    stats: [
      {
        text: "Geospatial gap analysis to identify underserved corridors across all 83 counties",
        source: "HRSA HPSA data",
      },
      {
        text: "Transit-health intersection mapping using live GTFS feeds",
      ...
      {
        text: "Multi-language access (EN/ES/AR/BN) for Michigan's diverse populations",
  ...
  },
  {
    ...
    stats: [
      ...
      {
        text: "Community Health Needs Assessment (CHNA) alignment for IRS Schedule H",
...
const audiences = [
  {
    ...
    link: "/for-health-systems",
  },
  {
    icon: Heart,
    label: "Nonprofits",
    cta: "View Impact Scenarios",
    link: "/impact",
  },
  {
    icon: Landmark,
    label: "Policymakers",
    cta: "See Equity Framework",
    link: "/equity",
  },
];
        ...
        <div className="container max-w-5xl">
          ...
          >
            ...
            <h1 className="text-3xl font-bold text-foreground lg:text-4xl mb-3">
              Access Michigan: Civic Health Infrastructure
            </h1>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              A statewide population health navigation platform aggregating
              public data across all 83 Michigan counties to support health
              equity, community navigation, and institutional planning. The
              platform includes a live business development financial modeler at{" "}
              <Link
                to="/bd-financial-model"
          ...
          >
            <Card className="border-primary/20 bg-gradient-to-br from-card to-primary/[0.03] overflow-hidden">
              <CardContent className="py-6 px-6 md:px-10">
                <h2 className="text-sm font-bold text-primary uppercase tracking-wider mb-5 text-center">
                ...
                <Card className={`h-full ${q.color}`}>
                  <CardContent className="py-5 space-y-3">
                    <div className="flex items-center gap-2">
                      ...
                      <h2 className="font-bold text-foreground tracking-wider text-sm">
                        {q.title}
                      </h2>
                    </div>
