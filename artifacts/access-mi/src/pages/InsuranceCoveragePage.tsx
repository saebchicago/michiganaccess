...
const FRESHNESS_STAMP = `Last verified ${PLATFORM_FRESHNESS.lastVerified} (pulled ${PLATFORM_FRESHNESS.lastPulled})`;
...
const PROGRAMS = [
  {
    ...
    covers:
      "Doctor visits, hospital stays, prescriptions, mental health, substance use treatment, dental, vision, lab work.",
    howToApply: "Apply online through MI Bridges or call MDHHS.",
    links: [
      {
        label: "Apply on MI Bridges",
        href: "https://newmibridges.michigan.gov/",
        external: true,
      },
      {
        label: "MDHHS Medicaid Info",
        href: "https://www.michigan.gov/mdhhs/assistance-programs/healthcare",
        external: true,
      },
    ],
    updated: "March 2026",
  },
  {
    ...
    covers:
      "Part A (hospital), Part B (outpatient/doctor), Part D (prescriptions). Medicare Advantage (Part C) bundles these through a private plan.",
    howToApply:
      "Enroll through Social Security Administration or Medicare.gov during enrollment periods.",
    links: [
      {
      ...
      {
        label: "MI SHINE Counseling",
        href: "https://mmapinc.org/medicare-medicaid-assistance-program/",
        external: true,
      },
    ],
    updated: "March 2026",
  },
  {
    ...
    covers:
      "All Marketplace plans cover Essential Health Benefits: doctor visits, emergency, hospitalization, prescriptions, maternity, mental health, preventive care.",
    howToApply:
      "Open Enrollment runs Nov 1 – Jan 15 annually. Special Enrollment Periods available for qualifying life events.",
    links: [
      {
      ...
      {
        label: "Find Local Enrollment Help",
  ...
  },
  {
    ...
    howToApply:
      "Walk in or call any FQHC. No referral needed. Bring proof of income for fee reduction.",
    links: [
      { label: "Find an FQHC Near You", href: "/find-care", external: false },
      {
        label: "HRSA Health Center Finder",
  ...
  },
  {
    ...
    covers:
      "Varies by plan. Michigan's largest insurer is Blue Cross Blue Shield of Michigan / Blue Care Network. Plans must cover Essential Health Benefits under ACA.",
    howToApply:
      "Enroll through your employer during open enrollment, or buy directly from the insurer. BCBSM offers a Patient Access portal for members to view coverage details, EOBs, and claims history.",
    links: [
      {
        label: "BCBSM Member Resources",
        href: "https://www.bcbsm.com/",
        external: true,
      },
      {
        label: "BCBSM Patient Access Portal",
        href: "https://www.bcbsm.com/member/",
        external: true,
      },
      {
        label: "Understand Your EOB",
...
const QUICK_PATHS = [
  {
    ...
    answer:
      "Start with Medicaid (if income-eligible) or an FQHC. Use the navigator below.",
    tab: "medicaid",
  },
  {
    question: "I just lost my job",
    answer:
      "You may qualify for a Special Enrollment Period on the Marketplace, COBRA continuation, or Medicaid.",
    tab: "marketplace",
  },
  {
    question: "I'm 65 or turning 65",
    answer:
      "You're likely eligible for Medicare. MI SHINE counselors can help you choose a plan at no cost.",
    tab: "medicare",
  },
  {
    question: "My claim was denied",
    answer:
      "You have the right to appeal. Access Michigan can generate a free appeal letter.",
    tab: "appeals",
  },
];
...
const EXPLAINER_CARDS = [
  {
    ...
    updated: `${FRESHNESS_STAMP}. Always confirm details with MDHHS, your plan, or an official source.`,
  },
  {
    ...
    updated: `${FRESHNESS_STAMP}. Always confirm details with Medicare.gov or a SHINE counselor.`,
  },
  {
        ...
        <div className="container py-12 md:py-16">
          ...
          >
            <Badge variant="outline" className="mb-3 text-xs">
              Independent civic guide · Not affiliated with any insurer or
              agency
            </Badge>
            ...
            <p className="text-muted-foreground text-base md:text-lg leading-relaxed max-w-2xl">
              ...
              <JargonTip
                term="Medicare"
                tip="Federal health insurance for people 65+ or with certain disabilities."
              />
              ,{" "}
              <JargonTip
                term="Marketplace"
            ...
            <p className="text-xs text-muted-foreground mt-3 flex items-center gap-1.5">
              <ShieldCheck className="h-3.5 w-3.5" /> No data collected · No
              account required · Sources: MDHHS, CMS, HRSA · {FRESHNESS_STAMP}
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="container pb-16">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="overview" className="space-y-8">
            ...
            <div>
              <h2 className="text-lg font-bold mb-4 flex items-center gap-2">
                <BookOpen className="h-5 w-5 text-primary" /> Understanding Your
                Options
              </h2>
                    ...
                    >
                      <Card className="h-full hover:border-primary/30 transition-colors">
                        <CardHeader className="pb-2">
                          <CardTitle className="text-sm flex items-center gap-2">
                            <span
                              className={`inline-flex items-center justify-center h-7 w-7 rounded-md ${p.color}`}
                            >
              ...
              <CardContent className="p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">
                    Access Michigan can generate a free appeal letter using AI,
                    with step-by-step guidance.
                  </p>
                </div>
                <Button asChild size="sm" className="gap-1.5">
                  <Link to="/health/insurance-appeals">
                    <FileText className="h-3.5 w-3.5" /> Appeal Generator{" "}
            ...
            return (
              <TabsContent key={p.id} value={p.id} className="space-y-6">
                <div className="flex items-start gap-3">
                  <span
                    className={`inline-flex items-center justify-center h-10 w-10 rounded-lg ${p.color}`}
                  >
                  ...
                  <Card>
                    <CardHeader className="pb-2">
                      <CardTitle className="text-xs flex items-center gap-1.5">
                        <Users className="h-3.5 w-3.5 text-primary" /> Who
                        Qualifies
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm leading-relaxed">{p.who}</p>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardHeader className="pb-2">
                    ...
                    <CardContent>
                      <p className="text-sm leading-relaxed">{p.covers}</p>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardHeader className="pb-2">
                      <CardTitle className="text-xs flex items-center gap-1.5">
                        <FileText className="h-3.5 w-3.5 text-primary" /> How to
                        Apply
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm leading-relaxed">{p.howToApply}</p>
                    </CardContent>
                  </Card>
                </div>
                  ...
                  <Card className="max-w-md">
                    <CardHeader className="pb-2">
                      <CardTitle className="text-sm flex items-center gap-1.5">
                        <DollarSign className="h-4 w-4 text-primary" /> Sliding
                        Fee Calculator
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-xs text-muted-foreground mb-3">
                        Use the Insurance Navigator below to estimate your FQHC
                        discount category.
                      </p>
                      <InsuranceNavigator />
                    </CardContent>
                ...
                {p.id === "medicaid" && (
                  <Card className="bg-muted/30">
                    <CardContent className="p-4 space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed">
                        Most Michigan Medicaid members are enrolled in a managed
                        care plan such as{" "}
                        <JargonTip
                          term="BCBS Complete"
                        ...
                        a primary care provider, and handles referrals.
                      </p>
                      <p className="text-xs text-muted-foreground">
                        Source:{" "}
                        <a
                          href="https://www.michigan.gov/mdhhs/doing-business/providers/providers/medicaid-health-plans"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="underline"
                        >
                          MDHHS Medicaid Health Plans
                        </a>
                      </p>
                    </CardContent>
                  </Card>
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  >
                    <Link to="/health/insurance-appeals">
                      <FileText className="h-3 w-3" /> Appeal a Denial
                    </Link>
                  </Button>
                  <Button
                    variant="outline"
                  ...
                  >
                    <Link to="/find-care">
                      <Stethoscope className="h-3 w-3" /> Find a Provider
                    </Link>
                  </Button>
                  <Button
                    variant="outline"
                  ...
                  >
                    <Link to="/financial-help">
                      <DollarSign className="h-3 w-3" /> Financial Assistance
                    </Link>
                  </Button>
                  <Button
                    variant="outline"
                  ...
                  >
                    <a href="tel:211">
                      <Phone className="h-3 w-3" /> Call 2-1-1
                    </a>
                  </Button>
                </div>
        ...
        <Card className="mt-8 border-border/50 bg-muted/20">
          <CardContent className="p-4">
            <p className="text-xs text-muted-foreground leading-relaxed flex items-start gap-2">
              ...
              <span>
                <strong>Looking ahead:</strong> In the future, we may let you
                securely connect your own health plan (for example, through
                Patient Access APIs) so you can see your personal coverage and
                claims alongside our community data. That will be opt-in,
                heavily protected, and never shared. For now, all data here is
                population-level and public.
              </span>
            </p>
          </CardContent>
        </Card>
        ...
        <div className="flex justify-center mt-8">
          <AskCopilotButton
            ...
            label="Ask Access Michigan about insurance options"
          />
        </div>
      </div>
    </Layout>
