      ...
      <Card>
        <CardContent className="py-4 flex items-start gap-3">
          ...
          <p className="text-sm text-muted-foreground">
            Select your county from the header to see whether Rx Kids serves
            your community.
          </p>
        </CardContent>
      </Card>
    ...
    return (
      <Card>
        <CardContent className="py-4 flex items-start gap-3">
          ...
          />
          <p className="text-sm text-muted-foreground">
            Rx Kids has not yet announced a community in {county} County. See
            the full coverage list below - the program has expanded to a new set
            of counties every few months.
          </p>
        </CardContent>
      </Card>
    );
    ...
    <Card className="border-michigan-forest/30 bg-michigan-forest/5">
      <CardContent className="py-4 space-y-2">
        <div className="flex items-center gap-2">
          <CheckCircle2
            className="h-4 w-4 text-michigan-forest-deep shrink-0"
            aria-hidden="true"
          />
...
export default function EarlyChildhoodPage() {
  ...
  return (
    <Layout>
      ...
      <section
        className="container max-w-4xl py-10 space-y-4"
      ...
      >
        <div className="flex items-center gap-2">
          <ProvenanceTag
            label="VERIFIED"
            source="Peer-reviewed: Lancet Public Health 2026; JAMA Network Open 2025"
          />
          <h2
            id="outcomes-heading"
        ...
        <p className="text-sm text-muted-foreground">
          Peer-reviewed evaluations of the Flint program - the site with enough
          enrollment history for a published outcomes study so far.
        </p>
          ...
          {RX_KIDS_OUTCOMES.map((o) => (
            <Card key={o.finding}>
              <CardContent className="py-3 space-y-1">
                ...
                <p className="text-sm text-michigan-forest-deep font-medium">
                  {o.metric}
                </p>
        ...
        <p className="text-xs text-muted-foreground">
          State investment: {RX_KIDS_PROGRAM_FACTS.stateInvestment} (
          {RX_KIDS_PROGRAM_FACTS.stateInvestmentSource}).
        </p>
      </section>

      <section
        className="container max-w-4xl py-6 space-y-3"
        aria-labelledby="full-coverage-heading"
      >
        <h2
          id="full-coverage-heading"
          className="text-lg font-bold text-foreground"
        >
          Full coverage list
        </h2>
            ...
            <Card key={countyName}>
              <CardContent className="py-3 space-y-1">
                <p className="text-sm font-semibold text-foreground flex items-center gap-1.5">
                  <Baby
                    className="h-3.5 w-3.5 text-michigan-teal-deep"
                    aria-hidden="true"
                  />
                  {countyName} County
                </p>
      ...
      <section
        className="container max-w-4xl py-8 space-y-4 border-t border-border/30"
        aria-labelledby="prek-heading"
      >
        <h2 id="prek-heading" className="text-lg font-bold text-foreground">
          Preschool in Michigan
        </h2>
        <p className="text-sm text-muted-foreground">
          PreK for All is Michigan's push toward universal state-funded
          preschool. Enrollment in the Great Start Readiness Program just hit a
          record high - but it still covers only about half of the state's
          four-year-olds.
        </p>
        ...
        <Card className="bg-muted/30">
          <CardContent className="py-4 space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              Assessment in 2021, so no county-level readiness indicator exists
              to show. The closest available proxy is 3rd-grade M-STEP English
              language arts proficiency - 38.9% in spring 2025, an 11-year low,
              down from 39.6% in 2024 (MDE / CEPI via MI School Data) - but that
              measures a different grade and a different construct, not a
              substitute for a readiness assessment. County-level childcare
