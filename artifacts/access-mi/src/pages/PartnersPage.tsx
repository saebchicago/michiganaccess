...
const METRICS = [
  ...
  {
    icon: FileText,
    label: "Monitored API Feeds",
    value: String(MONITORED_API_FEEDS_COUNT),
    trend: "CDC PLACES, NWS, FDA Recalls, ClinicalTrials.gov",
  },
  {
    icon: ClipboardList,
    label: "Municipalities Tracked",
    value: "170+",
    trend: "Governance & FOIA data",
  },
];
...
const PARTNER_CATEGORIES = [
  {
    ...
    description:
      "Community benefit reporting, CHNA data integration, and population health impact tracking",
    examples: [
  ...
  },
  {
    ...
    description:
      "Student transportation safety, digital education platforms, and family communication systems",
    examples: [
      "School bus safety technology providers",
      ...
      <div className="container py-8 space-y-12">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg">
            Platform coverage and database metrics for Access Michigan across
            all 83 counties.
          </p>
        </motion.div>
        ...
        <section aria-labelledby="stories-heading">
          ...
          <p className="text-center text-sm text-muted-foreground mb-8 max-w-2xl mx-auto">
            These are <strong>hypothetical examples</strong> showing how
            residents might use Access Michigan. They are not real people or
            measured outcomes.
          </p>
        ...
        <section aria-labelledby="health-systems-heading" className="py-4">
          <div className="text-center mb-8">
            ...
            <h2
              id="health-systems-heading"
              className="text-2xl font-bold text-foreground"
            >
              Amplify Community Benefit Impact
            </h2>
            <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
              See how Access Michigan can support your community health needs
              assessment, referral intelligence, and population health
              initiatives.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Understand which resources residents access in your service area. Identify referral patterns and gaps in the care continuum.",
                bullets: [
              ...
              },
              {
                ...
                title: "Gap Analysis",
                description:
                  "Identify unmet needs with real usage data across all 83 counties. Pinpoint where services are needed most.",
                bullets: [
              ...
              },
              {
                ...
                description:
                  "Quantify the impact of charity care and SDOH interventions with aggregated, non-identifiable platform data.",
                bullets: [
            ...
            <Card className="inline-block border-michigan-teal/20 bg-michigan-teal/5">
              <CardContent className="py-4 px-8 flex flex-col sm:flex-row items-center gap-4">
                <p className="text-sm text-foreground">
                  Ready to explore how Access Michigan can support your
                  community health strategy?
                </p>
                <Button
                  className="bg-michigan-teal hover:bg-michigan-teal/90 text-white shrink-0"
                  asChild
                >
        ...
        <section aria-labelledby="chna-heading" className="py-4">
            ...
            {[
              {
                ...
                desc: "County-level resource density vs. need indicators across food, housing, transportation, and mental health sectors.",
                format: "CSV",
              },
              {
                title: "Facility Utilization Metrics",
                desc: "Aggregated page views and referral patterns by facility type and county, benchmarked against state averages.",
                format: "CSV",
              },
              {
                title: "Community Feedback Summary",
                desc: "Anonymized satisfaction rates and thematic analysis of user feedback by page and sector.",
                format: "PDF",
              },
            ].map((item) => (
              <Card
                key={item.title}
                className="hover-lift border-michigan-forest/10"
              >
          ...
          <p className="text-center text-[10px] text-muted-foreground mt-4">
            All exports are strictly anonymized and aggregated. Access Michigan
            never collects or shares personal health information.
          </p>
        </section>
        ...
        <div className="text-center space-y-4 py-8">
          ...
          <p className="text-sm text-muted-foreground max-w-lg mx-auto">
            We welcome conversations with health systems, school districts, and
            civic technology providers about community impact collaboration.
          </p>
