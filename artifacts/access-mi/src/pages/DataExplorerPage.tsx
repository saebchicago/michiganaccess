...
export default function DataExplorerPage() {
  ...
  const [selectedDomain, setSelectedDomain] = useState<CensusDomain | "all">(
    "all",
  );
  const [selectedTable, setSelectedTable] = useState<CensusTableDef | null>(
    null,
  );
        ...
        <div className="container max-w-5xl">
          ...
          >
            ...
            <h1 className="text-3xl font-bold text-foreground md:text-4xl mb-3">
              Explore live Census data.
            </h1>
            <p className="text-lg text-muted-foreground max-w-2xl">
              50+ American Community Survey tables. Any Michigan county. Pick a
              topic and go.
            </p>
          </motion.div>
        </div>
      ...
      <div className="container max-w-5xl py-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <Input
              aria-label="Search tables (e.g., income, race, rent)"
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <ChevronRight
                      className={`h-3.5 w-3.5 ml-auto text-muted-foreground transition-transform ${isActive ? "rotate-90" : ""}`}
                    />
                  </div>
              ...
              <Card className="h-full flex items-center justify-center min-h-[300px]">
                <CardContent className="text-center py-12">
                  ...
                  <p className="text-sm text-muted-foreground max-w-sm">
                    Choose a Census table from the left panel to visualize data
                    for {selectedCounty} County.
                  </p>
                </CardContent>
              </Card>
            ) : (
                ...
                <CardHeader>
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    <CardTitle className="text-base">
                      {selectedTable.label}: {selectedCounty} County
                    </CardTitle>
        ...
        <p className="text-[10px] text-muted-foreground text-center">
          Data from the U.S. Census Bureau American Community Survey via the
          Census Bureau API. All data is public domain.
        </p>
      </div>
    </Layout>
  );
