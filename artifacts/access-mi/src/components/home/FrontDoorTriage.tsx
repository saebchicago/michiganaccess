...
const NEEDS = [
  {
    ...
    label: "Healthcare",
    icon: Heart,
    sub: "Find care, insurance, prescriptions",
    color: "text-red-500",
    route: "/find-care",
  },
  {
    ...
    label: "Food",
    icon: Apple,
    sub: "SNAP, food pantries, WIC",
    color: "text-green-600",
    route: "/financial-help",
  },
  {
    key: "housing",
    label: "Housing",
    icon: Home,
    sub: "Rent help, shelter, housing programs",
    color: "text-blue-600",
  ...
  },
  {
    ...
    label: "Energy Help",
    icon: Zap,
    sub: "LIHEAP, utility assistance, weatherization",
    color: "text-amber-500",
    route: "/environment/energy",
  },
  {
    key: "money",
    label: "Money / Benefits",
    icon: DollarSign,
    sub: "Unclaimed benefits, tax credits, SSI",
    color: "text-teal-600",
    route: "/financial-help",
  },
  {
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 1 && (
            ...
            >
              ...
              <p className="text-sm text-muted-foreground mb-6">
                Select the type of help you're looking for.
              </p>
          ...
          {step === 3 && (
            ...
            >
              ...
              <p className="text-sm text-muted-foreground mb-6">
                This helps us show which Michigan programs match these rules.
              </p>
              <div className="space-y-4">
                <div>
                  <label className="text-xs font-medium text-foreground mb-1.5 block">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className={`flex-1 rounded-lg border-2 py-2.5 text-sm font-medium transition-all ${insured === true ? "border-primary bg-primary/5 text-primary" : "border-border text-muted-foreground"}`}
                    >
                      Insured
                    </button>
                    <button
                      onClick={() => setInsured(false)}
                      className={`flex-1 rounded-lg border-2 py-2.5 text-sm font-medium transition-all ${insured === false ? "border-primary bg-primary/5 text-primary" : "border-border text-muted-foreground"}`}
                    >
                      Uninsured
                    </button>
                  </div>
              ...
              {(county || zip) && need && (
                ...
                >
                  <p className="text-sm font-medium text-foreground">
                    Find financial help that fits your situation.
                  </p>
                  <p className="text-xs text-muted-foreground mt-1">
                    Based on {county || `ZIP ${zip}`} - see which programs match
                    below.
                  </p>
                </motion.div>
              )}
              ...
              <div className="flex gap-3 mt-8">
                ...
                <Button onClick={handleFinish} className="flex-1">
                  Find Resources <ArrowRight className="ml-1.5 h-3.5 w-3.5" />
                </Button>
              </div>
            </motion.div>
          )}
