...
const pathways = [
  {
    ...
    supportText:
      "You're not alone - many Michiganders are finding affordable care right now.",
    description:
      "Find sliding-scale clinics, Medicaid enrollment, and charity care programs",
    links: [
      { label: "Check Medicaid Eligibility", href: "/financial-help" },
      { label: "Find Sliding-Scale Clinics", href: "/find-care" },
  ...
  },
  {
    ...
    description:
      "Find support groups, respite care, home health services, and caregiver resources",
    links: [
  ...
  },
  {
    ...
    supportText:
      "Welcome - getting settled is a process, and we're here to help.",
    description:
      "Find local doctors, enroll in coverage, and discover community services",
    links: [
...
const GuidedPathways = forwardRef<HTMLElement>(
  function GuidedPathways(_props, ref) {
        ...
        <div className="container">
          ...
          >
            ...
            <p className="mt-2 text-muted-foreground">
              Pick the situation that fits yours - we'll guide you to the right
              resources.
            </p>
          </motion.div>
                    ...
                    <TooltipTrigger asChild>
                      ...
                      >
                        ...
                        {p.badge && (
                          <Badge
                            variant="destructive"
                            className={`absolute top-3 right-3 text-[10px] ${p.pulse ? "animate-pulse" : ""}`}
                          >
                            {p.badge}
                          </Badge>
                        )}
                        ...
                        <CardContent className="py-6 space-y-3.5">
                          {/* Icon */}
                          <div
                            className={`inline-flex items-center justify-center rounded-lg p-2.5 ${p.iconBg} transition-transform duration-300 motion-safe:group-hover:scale-110 motion-safe:group-hover:rotate-3`}
                          >
                          ...
                          <p
                            className={`text-xs font-medium ${p.color} leading-relaxed`}
                          >
                            {p.supportText}
                          </p>
