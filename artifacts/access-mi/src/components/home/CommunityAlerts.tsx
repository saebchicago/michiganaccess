  ...
  if (alerts.length === 0)
    return (
      <p className="text-xs text-muted-foreground flex items-center gap-1">
        <Info className="h-3 w-3" /> No active weather alerts for your area.
      </p>
    );
      ...
      {alerts.slice(0, 5).map((a) => (
        ...
        >
          <div className="flex items-center gap-2 flex-wrap">
            <Badge
              className={`text-[9px] ${severityColor[a.severity] || severityColor.Unknown}`}
            >
              {a.severity}
            </Badge>
    ...
    <section className="py-8" id="community-alerts">
      <div className="container max-w-4xl">
          ...
          <Card className="mb-4 border-primary/20 bg-primary/5">
            <CardContent className="p-3 flex items-center gap-2">
              ...
              <span className="text-xs">
                Enter your ZIP code for localized alerts:
              </span>
              <Input
                placeholder="48226"
                value={zipInput}
              ...
              />
              <Button size="sm" className="h-7 text-xs" onClick={handleZipSave}>
                Set
              </Button>
            </CardContent>
          </Card>
        ...
        <div className="grid gap-3 md:grid-cols-2">
          ...
          <AlertCard
            open={openCards.utility}
            onToggle={() => toggle("utility")}
            title="Utility Rate Alerts"
            icon={Zap}
            timestamp="Mar 2026"
          >
            <div className="space-y-2">
              <div className="rounded-md bg-michigan-gold/10 border border-michigan-gold/20 p-2">
                <p className="text-[11px] leading-relaxed">
                  <strong>DTE Energy</strong> approved a $242M rate increase
                  effective March 5, 2026 (~$4.93/mo for avg residential
                  customers).
                </p>
                <a
                  href="https://michigan.gov/mpsc"
                  target="_blank"
              ...
              <div className="rounded-md bg-muted/30 border border-border/50 p-2">
                <p className="text-[11px] leading-relaxed">
                  <strong>Consumers Energy</strong> - Check current rates and
                  planned changes for non-DTE service areas.
                </p>
                <a
                  href="https://www.consumersenergy.com/residential/rates"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-[10px] text-primary hover:underline inline-flex items-center gap-0.5 mt-1"
                >
                  View Consumers Energy rates{" "}
                  <ExternalLink className="h-2.5 w-2.5" />
                </a>
              </div>
            </div>
          ...
          >
            <div className="space-y-2">
              <p className="text-[11px] text-muted-foreground">
                Find food pantries, meal programs, and emergency food assistance
                near you.
              </p>
              <div className="flex flex-wrap gap-2">
                ...
                <a
                  href="https://www.211.org/get-help/zip-lookup"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 text-[10px] text-primary hover:underline"
                >
              ...
              <div className="rounded-md bg-muted/30 border border-border/50 p-2">
                <p className="text-[11px]">
                  <strong>SNAP Benefits:</strong> Apply through MiBridges for
                  food assistance. Most households of 4 earning ≤$3,250/mo
                  qualify.
                </p>
              </div>
            </div>
          ...
          <AlertCard
            open={openCards.roads}
            onToggle={() => toggle("roads")}
            title="Road & Transit Conditions"
            icon={Construction}
            timestamp={now}
          >
            <div className="space-y-2">
              <p className="text-[11px] text-muted-foreground">
                County-level road closures, construction alerts, and transit
                updates.
              </p>
              <div className="flex flex-wrap gap-2">
                <a
                  href="https://mdotjboss.state.mi.us/MiDrive/map"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 text-[10px] text-primary hover:underline"
                >
                ...
                <a
                  href="https://www.michigan.gov/mdot/travel/construction"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1 text-[10px] text-primary hover:underline"
                >
              ...
              {county && (
                <p className="text-[10px] text-muted-foreground">
                  Showing conditions for <strong>{county} County</strong>. Check
                  MiDrive for real-time updates.
                </p>
              )}
            </div>
          </AlertCard>
          ...
          >
            <div className="space-y-2">
              <p className="text-[11px] text-muted-foreground">
                Apply for Michigan benefits through MiBridges - a single portal
              ...
              <a
                href="https://michigan.gov/mibridges"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {county && (
                <p className="text-[10px] text-muted-foreground">
                  Contact your <strong>{county} County</strong> MDHHS office for
          ...
          <AlertCard
            open={false}
            onToggle={() => toggle("mdhhs")}
            title="MDHHS & 211 Resources"
            icon={Info}
            timestamp="Live"
          >
            <div className="space-y-2">
              <p className="text-[11px] text-muted-foreground">
                Real-time resource availability through Michigan 211 and MDHHS.
              </p>
              <div className="flex flex-wrap gap-2">
                <a
        ...
        <div className="mt-4 pt-3 border-t border-border/30">
          <details className="text-[9px] text-muted-foreground">
            ...
            <p className="mt-1 leading-relaxed">
              Weather: National Weather Service API · Utility: Michigan Public
              Service Commission · Food: Feeding America, MDHHS, 211 · Roads:
              MDOT MiDrive · Benefits: MiBridges / MDHHS · Resources: Michigan
              211. Data cached locally for 15 minutes.
            </p>
          </details>
        </div>
      </div>
