    ...
    <section className="space-y-6" aria-labelledby="personas-heading">
      <div className="text-center space-y-2">
        ...
        <p className="mt-2 text-muted-foreground max-w-xl mx-auto">
          The following are example scenarios based on real Michigan appeal
          pathways, not verified individual cases.
        </p>
      </div>
              ...
              <Card className="h-full hover-lift">
                <CardContent className="p-6 space-y-4">
                  <div className="flex items-center gap-3">
                    <div
                      className={`flex h-12 w-12 items-center justify-center rounded-full ${persona.color}`}
                    >
                      {persona.icon}
                    </div>
                    ...
                    <Badge
                      variant="outline"
                      className="text-[9px] border-muted-foreground/30 text-muted-foreground shrink-0"
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <div>
                      <Badge
                        variant="secondary"
                        className="text-xs mb-1 bg-accent/10 text-accent"
                      >
                        The Solution
                      </Badge>
