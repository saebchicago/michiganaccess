...
const SUD_PROGRAMS = [
  {
    ...
    description:
      "Free 24/7 treatment referral service for substance use and mental health. Confidential, multilingual.",
  ...
  },
  {
    ...
    description:
      "Michigan's official directory connecting residents to local SUD treatment by county.",
  ...
  },
  {
    ...
    description:
      "Comprehensive addiction treatment: inpatient detox, residential, IOP, and adolescent programs.",
  ...
  },
  {
    ...
    description:
      "Drug & alcohol recovery: residential treatment, outpatient counseling, sober living in Northern MI.",
  ...
  },
  {
    ...
    description:
      "Assessment, treatment coordination, and recovery support for Oakland County residents.",
  ...
  },
  {
    ...
    description:
      "Naloxone distribution, overdose prevention, and harm reduction services.",
    ...
    <section className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-lg font-bold text-foreground">
            Substance Abuse Support Hub
          </h2>
          <p className="text-xs text-muted-foreground">
            Helplines, treatment centers, data insights & recovery resources
          </p>
        </div>
      </div>
                ...
                <CardContent className="p-4 flex flex-col gap-3 h-full">
                  ...
                  <div className="mt-auto flex gap-2 flex-wrap">
                    ...
                    <Button
                      ...
                      onClick={() => handleShare(p.title, p.url)}
                    >
      ...
      <Tabs defaultValue="trends" className="space-y-4">
        <TabsList className="flex-wrap h-auto gap-1">
          ...
          <TabsTrigger value="county" className="text-xs gap-1">
            <MapPin className="h-3.5 w-3.5" />
            By County
          </TabsTrigger>
          <TabsTrigger value="youth" className="text-xs gap-1">
            <Activity className="h-3.5 w-3.5" />
            Youth Use
          </TabsTrigger>
          <TabsTrigger value="treatment" className="text-xs gap-1">
            ...
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between flex-wrap gap-2">
                <CardTitle className="text-sm">
                  Michigan Drug Overdose Deaths (2017–2023)
                </CardTitle>
                <Button
                  size="sm"
                  variant="outline"
                  ...
                  onClick={() =>
                    downloadCSV(
                      "mi-overdose-trends.csv",
                      ["Year", "Total", "Opioid", "Stimulant", "Alcohol"],
                      OVERDOSE_TRENDS.map((r) => [
                        r.year,
                        r.total,
                        r.opioid,
                        r.stimulant,
              ...
              <p className="text-xs text-muted-foreground">
                Michigan opioid deaths decreased ~5% in 2023 - the first
                sustained decline since 2018.
              </p>
            </CardHeader>
            <CardContent>
              ...
              <p className="text-[10px] text-muted-foreground mt-2 text-center">
                Sources:{" "}
                <a
                  href="https://michigan.gov/opioids/category-data"
                  target="_blank"
                ...
                ·{" "}
                <a
                  href="https://mi-suddr.com/resources-2"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-primary hover:underline"
                >
        ...
        <TabsContent value="county" className="space-y-3">
          <Card>
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between flex-wrap gap-2">
                <CardTitle className="text-sm">
                  Overdose Deaths by County (Top 10, 2023)
                </CardTitle>
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      downloadCSV(
                        "mi-county-overdose.csv",
                        ["County", "Deaths", "Rate_per_100k"],
                        COUNTY_OVERDOSE.map((r) => [
                          r.county,
                          r.deaths,
                          r.rate,
                        ]),
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-3">
                ...
                <a
                  ...
                  className="text-primary hover:underline"
                >
                  MODA Vulnerability Index
                </a>{" "}
                highlights zip codes with the highest need.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="youth" className="space-y-3">
          <Card>
            <CardHeader className="pb-2">
              <div className="flex items-center justify-between flex-wrap gap-2">
                <CardTitle className="text-sm">
                  Adolescent Substance Use (Monitoring the Future, 2024)
                </CardTitle>
                <Button
                  size="sm"
                  variant="outline"
              ...
              <p className="text-xs text-muted-foreground">
                Past-year use prevalence among U.S. students - a key indicator
                for Michigan prevention programs.
              </p>
            </CardHeader>
            <CardContent>
              ...
              <p className="text-[10px] text-muted-foreground mt-2 text-center">
                Source:{" "}
                <a
                  href="https://monitoringthefuture.org"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-primary hover:underline"
                >
        ...
        <TabsContent value="treatment" className="space-y-3">
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm">
                Michigan SUD Treatment Admissions by Substance (2023)
              </CardTitle>
              <p className="text-xs text-muted-foreground">
                Distribution of treatment admissions by primary substance.
              </p>
            </CardHeader>
            <CardContent className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1 space-y-2 text-sm text-muted-foreground">
                <p>
                  <strong className="text-foreground">38%</strong> of treatment
                  admissions are opioid-related, reflecting Michigan's ongoing
                  opioid crisis.
                </p>
                <p>
                  <strong className="text-foreground">Naloxone access</strong>{" "}
                  expanded in 2023 with standing orders in all 83 counties.
                </p>
                <p className="text-xs">
                  Data:{" "}
                  <a
                  ...
                  ·{" "}
                  <a
                    href="https://injurycenter.umich.edu/opioid-surveillance"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-primary hover:underline"
                  >
                    U-M Opioid Surveillance
                  </a>
                </p>
              </div>
            </CardContent>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        {[
          {
            title: "MODA Dashboard",
            desc: "Interactive overdose heatmaps by county/ZIP with vulnerability index.",
            url: "https://michigan.gov/opioids/category-data",
            source: "michigan.gov",
          },
          {
            title: "MI-SUDDR Resources",
            desc: "Drug trends, treatment data, harm reduction dashboards, and reports.",
            url: "https://mi-suddr.com/resources-2",
            source: "mi-suddr.com",
          },
          {
            title: "Monitoring the Future",
            desc: "National adolescent substance use survey - charts and annual reports.",
            url: "https://monitoringthefuture.org",
            source: "monitoringthefuture.org",
          },
          {
            title: "U-M Opioid Surveillance",
            desc: "Michigan opioid data, injury center analytics, and SOS county summaries.",
            url: "https://injurycenter.umich.edu/opioid-surveillance",
            source: "umich.edu",
          },
        ].map((d) => (
      ...
      <Card className="border-border/50 bg-muted/30">
        <CardContent className="py-3">
          <p className="text-[11px] text-muted-foreground leading-relaxed">
            ...
            <strong>Sources:</strong> Michigan MODA Dashboard, MI-SUDDR, CDC
            WONDER, Monitoring the Future 2024, U-M Injury Prevention Center.{" "}
            <strong>
              All data shown is modeled or estimated from published reports and
              may differ from final official figures.
            </strong>{" "}
            Visualizations are for informational and advocacy support, not
            individualized risk prediction. For crisis help, call{" "}
            <strong>988</strong> or <strong>1-800-662-4357</strong> (SAMHSA).
          </p>
        </CardContent>
      </Card>
    </section>
