...
const TYPE_COLORS: Record<string, string> = {
  nutrition: "bg-michigan-forest/10 text-michigan-forest-deep",
  insurance: "bg-primary/10 text-primary",
  data: "bg-michigan-teal/10 text-michigan-teal-deep",
  safety: "bg-michigan-coral/10 text-michigan-coral-deep",
  health: "bg-michigan-teal/10 text-michigan-teal-deep",
  financial: "bg-michigan-gold/10 text-michigan-gold-deep",
  food: "bg-michigan-forest/10 text-michigan-forest-deep",
  energy: "bg-michigan-gold/10 text-michigan-gold-deep",
  employment: "bg-primary/10 text-primary",
  counseling: "bg-michigan-teal/10 text-michigan-teal-deep",
  pharmacy: "bg-michigan-coral/10 text-michigan-coral-deep",
  services: "bg-muted text-muted-foreground",
  legal: "bg-primary/10 text-primary",
  housing: "bg-michigan-gold/10 text-michigan-gold-deep",
  crisis: "bg-michigan-coral/10 text-michigan-coral-deep",
  care: "bg-michigan-teal/10 text-michigan-teal-deep",
  research: "bg-michigan-forest/10 text-michigan-forest-deep",
  support: "bg-primary/10 text-primary",
  access: "bg-michigan-teal/10 text-michigan-teal-deep",
  language: "bg-michigan-gold/10 text-michigan-gold-deep",
  community: "bg-michigan-forest/10 text-michigan-forest-deep",
};
