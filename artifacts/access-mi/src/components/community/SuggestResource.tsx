  ...
  const handleSubmit = async () => {
    ...
    try {
      if (supabaseConfigured) {
        await supabase.from("community_submissions" as any).insert({
          ...
          >
            {submitted ? (
              <div className="flex items-center gap-2 text-sm text-green-600">
                <Check className="h-4 w-4" /> Thank you - your feedback helps
              ...
              <>
                <div>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {[
                      {
                        key: "suggest_resource" as const,
                        label: "Suggest a resource",
                      },
                      {
                        key: "report_issue" as const,
                        label: "Report an error",
                      },
                      {
                        key: "data_correction" as const,
                        label: "Correct data",
                      },
                    ].map(({ key, label }) => (
                      <button
                ...
                <textarea
                  ...
                  placeholder={
                    type === "suggest_resource"
                      ? "Name of resource, organization, or program to add..."
                      : type === "report_issue"
                        ? "Describe the issue..."
                ...
                <p className="text-[9px] text-muted-foreground">
                  Submissions are reviewed by the accessmi.org team. No account
                  required.
                </p>
              </>
            )}
