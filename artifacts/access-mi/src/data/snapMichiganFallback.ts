...
// `node scripts/build-snap-county-dataset.mjs` from the USDA Food and
// Nutrition Administration (FNA, formerly FNS) FNS-388A project-area /
// county participation release. The seed values were transcribed from
// the published FY2022 county tables (most recent county file, ~2-year
// lag); the script overwrites them in place once a newer FNS-388A
// release parses and validates. Do not hand-edit the JSON.
//   Source: USDA FNA "SNAP: Average Monthly Participation by State and County"
...
//   Source: USDA FNA State Data Tables (snap-persons-6.xlsx, snap-households-6.xlsx
...
// All 83 Michigan counties - USDA FNA (formerly FNS) FY2022 average monthly participation.
...
export const SNAP_STATE_FALLBACK: SnapStateData = {
  // Michigan statewide monthly enrollment - USDA FNA state tables.
