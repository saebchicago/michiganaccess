#!/usr/bin/env node
/**
 * Refresh `src/data/county-snap-retailers.ts` from the USDA-FNA (formerly
 * FNS) Historical SNAP Retailer Locator data release. Filters to Michigan
 * rows that are currently authorized (End Date blank), aggregates per county
 * using the source's already-populated `County` field, and computes per-
 * 10,000-resident rates against the existing PEP V2024 county population.
 *
 ...
 * USDA-FNA national publication on fna.usda.gov is the canonical feed and
 ...
 *
 * Source: USDA Food and Nutrition Administration (FNA, formerly FNS),
 *   Historical SNAP Retailer Locator Data 2005-2025
 *   https://www.fna.usda.gov/snap/retailer/data
 *
 ...
 *
 * Source: USDA Food and Nutrition Administration (FNA, formerly FNS),
 *   Historical SNAP Retailer Locator Data 2005-2025 (bulk CSV release).
 *   https://www.fna.usda.gov/snap/retailer/data
 *
