...
const allPrograms: Program[] = [
  ...
  { name: "LIHEAP (Heating Assistance)", description: "Help paying home heating bills during cold months.", eligibility: "Income ≤ 150% FPL", link: "/financial-help", category: "energy" },
  { name: "Consumers Energy — Helping Neighbors", description: "Free home energy upgrades for income-qualified customers.", eligibility: "Income ≤ 200% FPL", link: "/environment", category: "energy" },
  { name: "MiHER HOMES Rebate", description: "Up to $8,000 for whole-home energy efficiency improvements.", eligibility: "Income ≤ 150% FPL (max rebate)", link: "/environment", category: "energy" },
  { name: "MiHER HEAR Rebate", description: "Point-of-sale rebates up to $14,000 for heat pumps and electrification.", eligibility: "Income ≤ 150% FPL", link: "/environment", category: "energy" },
  { name: "Michigan Saves Green Loans", description: "Low-interest financing for solar, HVAC, and insulation upgrades.", eligibility: "All income levels", link: "/environment", category: "energy" },
