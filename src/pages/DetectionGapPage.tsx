...
const STAGES = [
  ...
  { id: "detect", title: "Needs Are Detected", stat: "27.4%", label: "of screened patients have at least one unmet social need", desc: "Trinity Health screened over 1 million outpatients for social determinants of health in FY2025 and found 27.4% reported at least one unmet need — food insecurity, housing instability, transportation barriers, or utility needs. Across Michigan, that represents hundreds of thousands of patients annually.", visual: "funnel-mid" as const, source: "Trinity Health Community Impact Report, FY2025 (published Jan 2026)" },
  { id: "gap", title: "The Gap Opens", stat: "~65%", label: "of those with needs are not connected to services", desc: "Even when needs are detected, the majority of patients are not connected to community resources. Barriers include: stigma, lack of awareness of available programs, complex enrollment processes, and the absence of a structured pathway from screening to service connection.", visual: "gap" as const, source: "CDC SDOH evidence; Trinity Health FY2025 data" },
        ...
        <div className="max-w-5xl mx-auto px-6 pb-16">
          ...
          <div className="mt-12 rounded-lg border border-white/10 bg-white/5 p-4">
            <p className="text-xs text-gray-500">
              <strong className="text-gray-400">Data Sources:</strong> Michigan DHHS SDOH Screening Program, Trinity Health Community Impact Report (FY2025, published Jan 2026), CDC Social Determinants of Health, Access Michigan Platform. All statistics reflect published research data; see <a href="/methodology" className="text-primary hover:underline">Methodology</a>.
            </p>
          </div>
        </div>
      </div>
