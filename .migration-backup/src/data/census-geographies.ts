/**
 * Michigan FIPS Code Lookup
 * Maps county names to 3-digit FIPS county codes (within state 26).
 */

export const MI_COUNTY_FIPS: Record<string, string> = {
...
/** Get 3-digit FIPS code for a county name */
export function getCountyFips(countyName: string): string | null {
  return MI_COUNTY_FIPS[countyName] || null;
}

/** Get county name from FIPS code */
export function getCountyFromFips(fips: string): string | null {
