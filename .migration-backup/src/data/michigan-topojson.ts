/** Michigan FIPS code and county lookup tables for D3 choropleth */

export const MICHIGAN_FIPS = "26";

export function isMichiganCounty(fips: string): boolean {
  return fips.startsWith("26");
}

export const FIPS_TO_COUNTY: Record<string, string> = {
...
export const COUNTY_TO_FIPS: Record<string, string> = Object.fromEntries(
  Object.entries(FIPS_TO_COUNTY).map(([k, v]) => [v, k])
);
