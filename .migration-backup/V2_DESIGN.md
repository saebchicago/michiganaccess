...
| GAO-20-149 / Sommers et al. NEJM 2019 | GAO-20-149 documents administrative costs of Medicaid work requirement implementation (not a coverage loss source). Sommers NEJM 2019: approximately 18,000 Arkansas adults lost coverage in the first year of implementation (June 2018 through April 2019) | 2020 / 2019 | GAO-20-149 cited for implementation burden context only. Sommers NEJM 2019 (NEJMsr1901772) is the peer-reviewed coverage loss source. Coverage loss rates come from Urban Institute / Sommers, not from GAO-20-149 |
